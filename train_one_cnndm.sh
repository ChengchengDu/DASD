...
--output_dir /home/jazhan/code/query_based_summarization/checkpoint_span/cnndm_checkpoint/  \
...
--logging_steps 10 \
--save_steps 5000 \
--log_dir /home/jazhan/code/query_based_summarization/checkpoint_cnndm/cnndm_runs \
--log_file /home/jazhan/code/query_based_summarization/checkpoint_cnndm/cnndm_train.log \
--learning_rate 3e-5 \
--warmup_steps 500 \
--weight_decay 0.01 \
--sortish_sampler \
